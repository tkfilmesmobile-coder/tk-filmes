...
> "Pra o estilo tweet, preciso de uma foto de perfil. Joga o arquivo na pasta da marca, como `foto-perfil.jpg` (te digo o caminho). Se não tiver agora, uso as iniciais do teu nome."

- Guardar como `foto-perfil.jpg` (ou `.png`) na pasta da marca, junto do guia de design
