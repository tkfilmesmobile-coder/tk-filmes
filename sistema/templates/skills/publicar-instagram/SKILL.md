...
4. **Conferir o script de publicação:**
   `scripts/publish-postforme.js` vem dentro desta skill e roda de lá. Não copiar pra fora: assim a skill viaja inteira quando a pasta for compartilhada.
...
6. **Conferir o script:**
   `scripts/publish-graph-api.js` vem dentro desta skill e roda de lá. Não copiar pra fora.
...
Os comandos abaixo rodam da raiz do sistema. Se a skill mora na pasta de um projeto, o caminho é `<pasta>/.claude/skills/publicar-instagram/scripts/...`.
